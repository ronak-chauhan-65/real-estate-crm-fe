...
import { PropertySpecificTypeApiList } from "../../components/APICalls/Configure";
...
function PropertyType() {
  ...
  const handlePropertyType = async () => {
    const repsonse =
      await PropertySpecificTypeApiList.getPropertySpecificType();
  ...
  const handleDelete = useCallback(async (id) => {
    const response =
      await PropertySpecificTypeApiList.DeletePropertySpecificType(id);
  ...
  const handleSave = async () => {
    if (formValidation() && !onEditID) {
      const response =
        await PropertySpecificTypeApiList.PostPropertySpecificType({
          name: formData?.name,
          propertyConstructionType: formData?.dropdownValue,
        });
      console.log(response, "repsonserepsonserepsonse");
      ...
      const repsonse = await PropertySpecificTypeApiList.UpdatePropertyType(
        onEditID,
        {
          name: formData?.name,
          propertyConstructionType: formData?.dropdownValue,
